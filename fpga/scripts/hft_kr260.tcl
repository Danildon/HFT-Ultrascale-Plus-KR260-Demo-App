...
#
# hft_kr260.tcl: Tcl script for re-creating project 'hft_kr260'
#
# Generated by Vivado on Thu Apr 16 11:58:43 -0400 2026
...
#
# 1. This project restoration tcl script (hft_kr260.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/data/hft-kr260/fpga/scripts/vivado_project/hft_kr260.srcs/sources_1/bd/kr260_system/kr260_system.bd"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/data/hft-kr260/fpga/rtl/market_data_parser.v"
#    "C:/data/hft-kr260/fpga/rtl/msg_framer.v"
#    "C:/data/hft-kr260/fpga/rtl/order_book_engine.v"
#    "C:/data/hft-kr260/fpga/rtl/tob_axi_lite.v"
#    "C:/data/hft-kr260/fpga/rtl/kr260_top.v"
#    "C:/data/hft-kr260/fpga/constraints/kr260.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../scripts/vivado_project/hft_kr260.srcs/sources_1/bd/kr260_system/kr260_system.bd"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/../rtl/market_data_parser.v"]"\
 "[file normalize "$origin_dir/../rtl/msg_framer.v"]"\
 "[file normalize "$origin_dir/../rtl/order_book_engine.v"]"\
 "[file normalize "$origin_dir/../rtl/tob_axi_lite.v"]"\
 "[file normalize "$origin_dir/../rtl/kr260_top.v"]"\
 "[file normalize "$origin_dir/kr260.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set orig_proj_dir "[file normalize "$origin_dir/../scripts/vivado_project"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../kria_ref_files/kria-vitis-platforms/kr260/platforms/vivado/board_files/kr260_carrier/1.0"] [file normalize "$origin_dir/../../../kria_ref_files/kria-vitis-platforms/kr260/platforms/vivado/board_files/kr260_som/1.0"]" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse kr260_system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../scripts/vivado_project/hft_kr260.gen/sources_1/bd/kr260_system/hdl/kr260_system_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse kr260_system.bd] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}


# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../rtl/market_data_parser.v"
...
set file "$origin_dir/../rtl/msg_framer.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../rtl/order_book_engine.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../rtl/tob_axi_lite.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/../rtl/kr260_top.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "kr260_system/kr260_system.bd"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set_property -name "top" -value "kr260_system_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/kr260.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/kr260.xdc"
set file [file normalize $file]
...
set_property -name "top" -value "kr260_top" -objects $obj
set_property -name "top_file" -value "../rtl/kr260_top.v" -objects $obj
